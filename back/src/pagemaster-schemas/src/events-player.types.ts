...
export enum EventPlayerTypes {
  ...
  PLAYER_INVENTORY_ITEM_GIVE = 'player.inventory.item.give',
...
export type EventPlayerInventoryItemGive = EventPlayerInventoryBase & {
  type: EventPlayerTypes.PLAYER_INVENTORY_ITEM_GIVE,
